...
mixin _$CategoriesStore on CategoriesStoreBase, Store {
  late final _$selectedSortTypeAtom =
      Atom(name: 'CategoriesStoreBase.selectedSortType', context: context);
  ...
  late final _$selectedIntervalTypeAtom =
      Atom(name: 'CategoriesStoreBase.selectedIntervalType', context: context);
  ...
  late final _$setSelectedSortTypeAsyncAction =
      AsyncAction('CategoriesStoreBase.setSelectedSortType', context: context);
